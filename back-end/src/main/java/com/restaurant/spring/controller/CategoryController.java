...
public class CategoryController {
    ...
    @GetMapping("/getAll")
    public ResponseEntity<CategoryResponseVm> getAllCategoriesWithPagination(@RequestParam int page, @RequestParam int size) {
        CategoryResponseVm categories = categoryService.getAllCategoriesWithPagination(page, size);
        return ResponseEntity.ok(categories);
    }
    ...
    @GetMapping("/search")
    public CategoryResponseVm searchCategories(@RequestParam String keyword,
